...
## S Fig 2B- In/out activity ratio
...
emm1 = emmeans(lmm, specs = pairwise ~ random|nov:sal, adjust = "tukey")
tt = pairs(emm1, adjust='tukey')
...
ggsave(file.path(out_folder,'sfig2_PCs.png'), plot_all, height = 6, width = 8)
ggsave(file.path(out_folder,'sfig2_PCs.pdf'), plot_all, height = 6, width = 8)
